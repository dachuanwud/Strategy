...
# 股票日线数据
stock_data_path = r'/Users/lishechuan/python/coincock/program/_财务数据选股策略_小组专用代码/data/daily_data'

# 财务数据路径
finance_data_path = r'/Users/lishechuan/python/coincock/program/_财务数据选股策略_小组专用代码/data/fin_data'

# 指数数据路径
index_path = r'/Users/lishechuan/python/coincock/program/_财务数据选股策略_小组专用代码/data/index_data/sh000300.csv'
...
raw_fin_cols = list(set(raw_fin_cols))
flow_fin_cols = list(set(flow_fin_cols))
cross_fin_cols = list(set(cross_fin_cols))
derived_fin_cols = list(set(derived_fin_cols))
# !!!
