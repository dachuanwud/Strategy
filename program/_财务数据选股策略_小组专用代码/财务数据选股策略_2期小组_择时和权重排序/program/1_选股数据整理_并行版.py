...
if __name__ == '__main__':
    ...
    # # 新上市
    # df = calculate_by_stock('sz300999')
    # # 2007前退市
    # df = calculate_by_stock('sh600002')
    # # ROE 连续几个季度增长
    # df = calculate_by_stock('sz300363')
    # exit()
    # df = calculate_by_stock('sz002302')
    # exit()
    # stock_code_list = ['sh600000', 'sz300999', 'sh600002', 'sz300363','bj430564']
