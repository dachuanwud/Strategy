...
def cal_tech_factor(df, extra_agg_dict):
    ...
    df['MA34_斜率_30'] = df['均线_34'] / df['均线_34'].shift(30)
    df['MA34_斜率_30'] = df['MA34_斜率_30'].apply(lambda x: math.atan((x - 1) * 100) * 180 / 3.1415926)
    extra_agg_dict['MA34_斜率_30'] = 'last'
