...
from Filter import *
from Filter_M import *
from Filter_W_test import *
from Filter_W_RED import *
...
print(select_stock.tail(100))

good = select_stock['选股下周期涨跌幅'][select_stock['选股下周期涨跌幅']>0.05].count()
print('下周期大于0.5的数量  ', good)
# 输出选股详情
select_stock.to_csv(
